...
void Bunuh(char* kill){
  FILE *killer;
  printf("1%s\n",kill);
  killer = fopen("/home/stoe/PRAKTIKUM/MODUL2/soal2/killer","w+");
  if(strcmp(kill,"-a")==0){
...
int main(int argc, char* argv[]) {
  ...
  * (nilai variabel pid adalah PID dari child process) */
  ...
  while (1) {
    ...
    char tmppath[100] = "/home/stoe/PRAKTIKUM/MODUL2/soal2/";// array untuk menyimpan path
    ...
    printf("anak3\n");
      for(i=0 ; i<=2 ; i++){
        // dirname2=dirname;
        if(i==2){
          char *zipname=dirname;
          strcat(dirname,".zip");
          printf("a%s %s",zipname,dirname);
          char *argu[] = {"ZIP","-rm", dirname, zipname, NULL};//membuat array yang menyimpan perintah membuat direktori
